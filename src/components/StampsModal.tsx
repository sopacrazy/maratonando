                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500 dark:text-text-secondary">
                                {showHelp ? 'Entenda como colecionar' : 'Sua coleção de conquistas'}
                            </p>
                        </div>
                    </div>
                    <button
                        ...
                        <div className="space-y-6 animate-in slide-in-from-right-4 fade-in duration-300">
                             ...
                             <div className="bg-primary/5 dark:bg-primary/10 p-4 rounded-xl border border-primary/10">
                                ...
                                <p className="text-sm text-slate-600 dark:text-gray-300 leading-relaxed">
                                    Selos são conquistas digitais que marcam sua jornada.
                                    Alguns são <strong>ilimitados</strong> (para todos que cumprirem a meta), enquanto outros são <strong>limitados e numerados</strong>, tornando-se raridades na comunidade!
                                </p>
                             </div>

                             {/* Rarities */}
                             <div>
                                <h4 className="font-bold text-slate-900 dark:text-white mb-3">Níveis de Raridade</h4>
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="p-3 rounded-lg bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10">
                                        <span className="text-xs font-bold text-slate-500 uppercase">Comum</span>
                                        <p className="text-xs text-slate-500 mt-1">Fáceis de obter, início da jornada.</p>
                                    </div>
                                    <div className="p-3 rounded-lg bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20">
                                        <span className="text-xs font-bold text-blue-500 uppercase">Raro</span>
                                        <p className="text-xs text-blue-600/80 dark:text-blue-400 mt-1">Conquistas específicas.</p>
                                    </div>
                                    <div className="p-3 rounded-lg bg-purple-50 dark:bg-purple-500/10 border border-purple-100 dark:border-purple-500/20">
                                        <span className="text-xs font-bold text-purple-500 uppercase">Épico</span>
                                        <p className="text-xs text-purple-600/80 dark:text-purple-400 mt-1">Desafios difíceis.</p>
                                    </div>
                                    <div className="p-3 rounded-lg bg-yellow-50 dark:bg-yellow-500/10 border border-yellow-100 dark:border-yellow-500/20">
                                        <span className="text-xs font-bold text-yellow-600 uppercase">Lendário</span>
                                        <p className="text-xs text-yellow-700/80 dark:text-yellow-400 mt-1">Apenas para os melhores.</p>
                                    </div>
                                </div>
                             </div>
                             ...
                             <div className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-gray-900 to-slate-800 text-white shadow-lg">
                                <div className="size-12 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                                    <span className="material-symbols-outlined text-2xl text-yellow-400">storefront</span>
                                </div>
                                <div>
                                    <h4 className="font-bold text-white">Mercado de Selos</h4>
                                    <p className="text-xs text-gray-300 mt-1 mb-3">
                                        Alguns selos são limitados! Se perder algum, você pode tentar comprar de outros usuários no Mercado.
                                    </p>
                                    <a href="#/market" onClick={onClose} className="inline-block text-xs font-bold bg-white text-slate-900 px-3 py-1.5 rounded-lg hover:bg-gray-100 transition-colors">
                                        Ir para o Mercado
                                    </a>
                                </div>
                             </div>
